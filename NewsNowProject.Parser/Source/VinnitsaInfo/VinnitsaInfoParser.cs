...
{
    public class VinnitsaInfoParser : IParser<List<Article>>
    {
        public IParserSettings parserSettings { get; set; }
        public VinnitsaInfoParser()
        {
            parserSettings = new VinnitsaInfoSettings();
        }
        public List<Article> Parse(IElement element)
        {
            var list = new List<Article>();
            var items = element.GetElementsByClassName("Psubj");
        ...
        {
            return document.GetElementsByClassName("topOnline").FirstOrDefault();
        }
