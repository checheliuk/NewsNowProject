...
{
    public class MyVinParser : IParser<List<Article>>
    {
        public IParserSettings parserSettings { get; set; }
        public MyVinParser()
        {
            parserSettings = new MyVinSettings();
        }
        public List<Article> Parse(IElement element)
        {
            var list = new List<Article>();
            var items = element.QuerySelectorAll(".post .post-title a");
        ...
        {
            return document.GetElementById("posts-window");
        }
